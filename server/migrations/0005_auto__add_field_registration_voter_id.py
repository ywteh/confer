...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.voter_id'
        db.add_column('registrations', 'voter_id',
                      self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.voter_id'
        db.delete_column('registrations', 'voter_id')
    ...
    models = {
        ...
        'server.registration': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['server.User']"}),
            'voter_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True'})
        },
        'server.user': {
