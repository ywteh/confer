...
def prepare_data(data_file):
  ...
  for row in reader:
    ...
    s_date = unicode(row[6], "ISO-8859-1")
    s_time = unicode(row[7], "ISO-8859-1")
    paper_type = unicode("Paper", "ISO-8859-1")
    s_id = unicode(row[4], "ISO-8859-1")
    ...
    award_s = unicode(row[8], "ISO-8859-1")
    hm_s = unicode(row[9], "ISO-8859-1")
    award = False
    hm = False
...
def prepare_json_from_file(conf_name, file):
  data_file = file
