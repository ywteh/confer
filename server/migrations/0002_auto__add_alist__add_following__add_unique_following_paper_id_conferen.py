...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AList'
        db.create_table('alist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('registration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Registration'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user', to=orm['server.User'])),
            ('user_starred', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_starred', to=orm['server.User'])),
        ))
        db.send_create_signal('server', ['AList'])

        # Adding model 'Following'
        db.create_table('following', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('paper_id', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('server', ['Following'])

        # Adding unique constraint on 'Following', fields ['paper_id', 'conference', 'user']
        db.create_unique('following', ['paper_id', 'conference_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Following', fields ['paper_id', 'conference', 'user']
        db.delete_unique('following', ['paper_id', 'conference_id', 'user_id'])

        # Deleting model 'AList'
        db.delete_table('alist')
    ...
    models = {
        'server.alist': {
            'Meta': {'object_name': 'AList', 'db_table': "'alist'"},
